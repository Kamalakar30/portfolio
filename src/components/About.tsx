    ...
    return (
        <div className={styles.about}>
            ...
            <p style={{ color: 'rgba(220, 220, 220, 0.751)', fontSize: '1.2rem' }}>
                Passionate about modern technology and problem solving
            </p>
                ...
                <div className={styles.sec1}>
                    <div className={styles.sec3}>
                        <div className={styles.sec4}>
                            ...
                            .
                            <br />
                            I&apos;m currently pursuing a B.Tech degree in Artificial Intilligence and
                            Machine Learning at St peters Engineering college, Hyderabad.
                        </div>
                        <div className={styles.sec4}>
                            My core skills lie in Java,python and c and I’m actively honing my
