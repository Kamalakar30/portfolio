...
import { useProjectsDataStore } from '@/stores';
        ...
        >
            <div>
                <Image
                    ...
                    height={300}
                    loading="lazy"
                    className="rounded-lg mb-3 w-full h-60"
                />
            </div>
        ...
        <>
            <div className={styles.main}>
                <div className={styles.head} style={{ marginBottom: '4rem' }}>
                    My Recent{' '}
                    <span style={{ color: 'rgb(231, 120, 231)', fontWeight: 'bold' }}>Works</span>
                    <div
                        style={{
                            margin: '0.2rem',
                            fontSize: '1.2rem',
                ...
                <a href="https://github.com/Kamalakar30" target="_blank">
                    <div className={styles.card}>
                        <div className={styles.img}>
                            <div className={styles.img3}></div>
                        </div>
                        <div className={styles.title}>More on GitHub...</div>
                    </div>
                </a>
            </div>
        </>
